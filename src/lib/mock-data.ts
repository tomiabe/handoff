...
export function generateRun(id?: string): Run {
  ...
  return {
    ...
    client: "Acme Corp",
    scope: "External Network Pentest",
    status,
    startTime: "14:02:13 UTC",
    duration: status === "completed" ? "12m 47s" : null,
    findingsCount: 12,
    highestSeverity: "critical",
    pendingApprovals: status === "awaiting_approval" ? 2 : 0,
    steps,
  };
}
...
export function generateRuns(): Run[] {
  return [
    ...
    },
    {
      ...
      agentName: "Probe-07",
      client: "Initech Holdings",
      scope: "Cloud Configuration Review",
      status: "completed",
      duration: "8m 34s",
    ...
    },
    {
      ...
      scope: "Internal Active Directory Assessment",
      status: "completed",
      duration: "31m 09s",
